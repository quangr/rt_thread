...
#define USART2_RX_PIN                   (Pin10)

#define USART2_TX_PORT                  (PortA)
#define USART2_TX_PIN                   (Pin09)
#endif
...
#define USART1_RXTO_TMR0_UNIT           (M4_TMR01)
#define USART1_RXTO_TMR0_FCG_PERIPH     (PWC_FCG2_PERIPH_TIM01)
#define USART1_RXTO_TMR0_CH             (Tim0_ChannelA)
#define USART1_RXTO_INT_IRQn            (Int004_IRQn)
#define USART1_RXTO_INT_PRIO            (DDL_IRQ_PRIORITY_02)

#define USART1_RX_DMA_UNIT              (M4_DMA1)
#define USART1_RX_DMA_CH                (DmaCh0)
#define USART1_RX_DMA_INT_IRQn          (Int005_IRQn)
#define USART1_RX_DMA_INT_SRC           (INT_DMA1_TC0)
#define USART1_RX_DMA_INT_PRIO          (DDL_IRQ_PRIORITY_00)
#endif

#if defined(BSP_UART1_TX_USING_DMA)
#define USART1_TX_DMA_UNIT              (M4_DMA1)
#define USART1_TX_DMA_CH                (DmaCh3)
#define USART1_TC_DMA_INT_SRC           (INT_DMA1_TC3)
...
#define USART2_RXERR_INT_IRQn           (Int007_IRQn)
#define USART2_RXERR_INT_PRIO           (DDL_IRQ_PRIORITY_DEFAULT)

#define USART2_RX_INT_IRQn              (Int008_IRQn)
#define USART2_RX_INT_PRIO              (DDL_IRQ_PRIORITY_00)

#define USART2_TX_INT_IRQn              (Int009_IRQn)
#define USART2_TX_INT_PRIO              (DDL_IRQ_PRIORITY_DEFAULT)

#if defined(RT_SERIAL_USING_DMA)
#if defined(BSP_UART1_RX_USING_DMA)
#define USART2_RXTO_TMR0_UNIT           (M4_TMR01)
#define USART2_RXTO_TMR0_FCG_PERIPH     (PWC_FCG2_PERIPH_TIM01)
#define USART2_RXTO_TMR0_CH             (Tim0_ChannelB)
#define USART2_RXTO_INT_IRQn            (Int010_IRQn)
#define USART2_RXTO_INT_PRIO            (DDL_IRQ_PRIORITY_01)

#define USART2_RX_DMA_UNIT              (M4_DMA2)
#define USART2_RX_DMA_CH                (DmaCh0)
#define USART2_RX_DMA_INT_IRQn          (Int011_IRQn)
#define USART2_RX_DMA_INT_SRC           (INT_DMA2_TC0)
#define USART2_RX_DMA_INT_PRIO          (DDL_IRQ_PRIORITY_00)
#endif

#if defined(BSP_UART2_TX_USING_DMA)
#define USART2_TX_DMA_UNIT              (M4_DMA2)
#define USART2_TX_DMA_CH                (DmaCh3)
#define USART2_TC_DMA_INT_SRC           (INT_DMA2_TC3)
#define USART2_TC_INT_IRQn              (Int012_IRQn)
#define USART2_TC_INT_PRIO              (DDL_IRQ_PRIORITY_DEFAULT)
#endif
#endif
...
#define BSP_I2C1_SCL_PIN 0x25
#define BSP_I2C1_SDA_PIN 0x24
